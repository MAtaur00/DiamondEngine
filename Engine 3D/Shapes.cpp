...
void Shapes::Draw()
{
	if (ImGui::Begin("Shapes", &App->imgui->showShapes))
	{
		if (ImGui::Button("Sphere"))
		{
			...
			ResourceMesh* mesh = App->import->MeshParShape(shape, "Sphere");
		...
		if (ImGui::Button("Cube"))
		{
			...
			ResourceMesh* mesh = App->import->MeshParShape(shape, "Cube");
			par_shapes_free_mesh(shape);
		}
		...
		if (ImGui::Button("Cylinder"))
		{
			...
			ResourceMesh* mesh = App->import->MeshParShape(shape, "Cylinder");
			par_shapes_free_mesh(shape);
		}
		...
		if (ImGui::Button("Cone"))
		{
			...
			ResourceMesh* mesh = App->import->MeshParShape(shape, "Cone");
			par_shapes_free_mesh(shape);
		}
		...
		if (ImGui::Button("Knot"))
		{
			...
			ResourceMesh* mesh = App->import->MeshParShape(shape, "Knot");
			par_shapes_free_mesh(shape);
		}
		...
		if (ImGui::Button("Torus"))
		{
			...
			ResourceMesh* mesh = App->import->MeshParShape(shape, "Torus");
			par_shapes_free_mesh(shape);
		}
	}
	ImGui::End();
